...
config.DATASET.TRAIN.IDS_PATH = 'dataset/train_ids.json'
config.DATASET.TRAIN.CAPTION_PATH = 'dataset/train.json'
config.DATASET.TRAIN.ENC_CAPTION_PATH = 'dataset/train_encode.json'  # caption padded and encoded to indices
config.DATASET.TRAIN.FEATURE_PATH = 'dataset/feature/train'
config.DATASET.VAL.IDS_PATH = 'dataset/val_ids.json'
config.DATASET.VAL.CAPTION_PATH = 'dataset/val_1.json'
