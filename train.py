...
def main():
    # load train dataset
    train_data = CocoCaptionDataset(caption_file=cfg.DATASET.TRAIN.ENC_CAPTION_PATH, config=cfg, split='train')
    val_data = CocoCaptionDataset(caption_file=cfg.DATASET.VAL.CAPTION_PATH, config=cfg, split='val')
