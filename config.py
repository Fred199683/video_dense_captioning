...
config = Config() config.DATASET.VOCAB_SIZE = None config.DATASET.VOCAB_THRESHOLD = 1
...
config.SOLVER.TRAIN.BATCH_SIZE = 128            # batch size being used while training
config.SOLVER.TRAIN.EVAL_STEPS = 100            # steps taken before evaluation during training
